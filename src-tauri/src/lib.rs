...
use commands::{
    add_recent_database, clear_all_history, clear_audit_log, clear_clipboard,
    clear_entry_custom_icon, clear_entry_history, clear_recent_databases, clear_session_key,
    close_database, commit_prepared_attachments, copy_password_to_clipboard,
    copy_protected_field_to_clipboard, copy_text_to_clipboard, create_database, create_entry,
    create_group, create_manual_backup, delete_backup, delete_entry, delete_entry_attachment,
    delete_group, delete_tag, export_entry_attachment, fetch_entry_favicon, generate_keyfile,
    generate_passphrase, generate_password, get_app_preferences, get_audit_events,
    get_audit_status, get_custom_icons, get_database_config, get_database_info, get_entry,
    get_entry_attachment, get_entry_password, get_entry_protected_custom_field, get_group,
    get_group_entry_counts, get_history_entry_password, get_history_protected_field,

...
The SBOM file itself is attested to prove it was generated by our official CI workflow:

```bash
gh attestation verify mithril-vault-sbom.json --owner SchnitzelAndSpaetzle
```

This verifies that the SBOM was produced by the official GitHub Actions workflow and has not been tampered with.
